...
public class PageInfo {
		...
		int endPage;	// 페이징바의 끝수// 전체 레코드 수(board테이블의 전체 행의 수)
		public PageInfo() {
		...
		public String toString() {
			return "PageInfo [totalRecord=" + totalRecord + ", numPerPage=" + numPerPage + ", pagePerBlock="
					+ pagePerBlock + ", nowPage=" + nowPage + ", totalPage=" + totalPage + ", startPage=" + startPage
					+ ", endPage=" + endPage + "]";
		}
